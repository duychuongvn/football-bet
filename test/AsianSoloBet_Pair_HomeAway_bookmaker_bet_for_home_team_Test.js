...
describe('When offer new match', () => {
  ...
  describe('When admin approve score and pair is Russia x/x USA (Russia is stronger than USA and bookmaker choose Russia, Punter choose USA)', async () => {
    ...
    contract("AsianSoloBet", accounts => {
      ...
      it('should transfer a half stake to punter when  pair is Russia 0:1/4 USA (0.25) and bookmaker choose Russia and the match draw', async () => {
      ...
      it('should transfer stake to punter when  pair is Russia 0:1/4 USA (0.25) and bookmaker choose Russia and the Russia loses ', async () => {
      ...
      it('should transfer stake to bookmaker when  pair is Russia 0:1/4 USA (0.25) and bookmaker choose Russia and the Russia win 1-0 ', async () => {
      ...
      it('should transfer stake to bookmaker when  pair is [Russia 0:1/2 USA] (0.5) and bookmaker choose Russia and the Russia win 1-0 ', async () => {
      ...
      it('should transfer stake to punter when  pair is [Russia 0:1/2 USA] (0.5) and bookmaker choose Russia and the Russia lose 0-1 ', async () => {
      ...
      it('should transfer stake to punter when  pair is [Russia 0:1/2 USA] (0.5) and bookmaker choose Russia  and the match result is Russia 2-2 USA (draw) ', async () => {
      ...
      it('should transfer stake to bookmaker when  pair is [Russia 0:3/4 USA] (0.75) and bookmaker choose Russia and the Russia win 3-1 ', async () => {
      ...
      it('should transfer a half stake to bookmaker when  pair is [Russia 0:3/4 USA] (0.75) and bookmaker choose Russia and the Russia win 2-1 ', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
      ...
      it('should transfer all stake to punter when  pair is [Russia 0:3/4 USA] (0.75) and bookmaker choose Russia and the match is draw 2-2 ', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
      ...
      it('should transfer all stake to punter when  pair is [Russia 0:3/4 USA] (0.75) and bookmaker choose Russia  and the match is Russia 2-3 USA (Russia lose)', async () => {
      ...
      it('should transfer all stake to bookmaker when  pair is [Russia 0:1 USA] (1.00) and bookmaker choose Russia and the match result Russia 2-0 USA (Russia win 2 goals)', async () => {
        ...
        //cannot verify exact amount due to lack of gas
        assert.equal(toGwei(amountOfBookMakerAfterApproveMatchScore), toGwei(amountOfBookMakerAfterOffer + totalAmountReceivedAfterWin) , "Bookmaker win all amount when result is Russia 2-0 USA" )
        assert.equal(toGwei(amountOfPunterAfterApproveMatchScore),toGwei(amountOfPunterAfterDeal), "Punter lose all amount when result is  Russia 2-0 USA");
      ...
      it('should transfer to punter when  pair is [Russia 0:1 USA] (1.00) and bookmaker choose Russia and the match is draw ', async () => {
      ...
      it('should transfer to punter when  pair is [Russia 0:1 USA] (1.00) and bookmaker choose Russia and the match result is Russia 1-2 USA (Russia lose) ', async () => {
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -100, {from: bookmaker, value: betAmount});
        // punter deals with bookmaker means that
        contract.deal(0x138, 0, {from: punter, value: betAmount});
      ...
      it('should transfer to bookmaker when  pair is [Russia 0:1 1/4 USA] (1.25) and bookmaker choose Russia and the match Russia 3-1 USA', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
      ...
      it('should transfer a half to bookmaker and punter when  pair is [Russia 0:1 1/4 USA] (1.25) and bookmaker choose Russia and the match Russia 3-2 USA (Russia win 1 goal)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -125, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to punter when  pair is [Russia 0:1 1/4 USA] (1.25) and bookmaker choose Russia and the match Russia 3-3 USA (draw)', async () => {
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -125, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to punter when  pair is [Russia 0:1 1/4 USA] (1.25) and bookmaker choose Russia and the match Russia 3-4 USA (Russia lose)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -125, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to bookmaker when  pair is [Russia 0:1 1/2 USA] (1.50) and bookmaker choose Russia and the match Russia 3-1  USA (Russia win 2 goals)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
      ...
      it('should transfer all to punter when  pair is [Russia 0:1 1/2 USA] (1.50) and bookmaker choose Russia and the match Russia 3-2  USA (Russia win 1 goals)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -150, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to punter when  pair is [Russia 0:1 1/2 USA] (1.50) and bookmaker choose Russia and the match Russia 3-3  USA (Russia draw)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -150, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to punter when  pair is [Russia 0:1 1/2 USA] (1.50) and bookmaker choose Russia and the match Russia 1-2  USA (Russia lose)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -150, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to bookmaker when  pair is [Russia 0:1 3/4 USA] (1.75) and bookmaker choose Russia and the match Russia 4-1  USA (Russia win >= 3 goals)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
      ...
      it('should transfer a half to bookmaker and punter when  pair is [Russia 0:1 3/4 USA] (1.75) and bookmaker choose Russia and the match Russia 4-2  USA (Russia win = 2 goals)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -175, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to punter when  pair is [Russia 0:1 3/4 USA] (1.75) and bookmaker choose Russia and the match Russia 4-3  USA (Russia win = 1 goals)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -175, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to punter when  pair is [Russia 0:1 3/4 USA] (1.75) and bookmaker choose Russia and the match Russia 4-4  USA (Russia draw)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -175, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to punter when  pair is [Russia 0:1 3/4 USA] (1.75) and bookmaker choose Russia and the match Russia 4-5  USA (Russia lose)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -175, {from: bookmaker, value: betAmount});
      ...
      it('should transfer all to bookmaker when  pair is [Russia 0:2 USA] (2.00) and bookmaker choose Russia and the match Russia 4-1  USA (Russia win >=3 goals)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
      ...
      it('should refund to bookmaker and punter when  pair is [Russia 0:2 USA] (2.00) and bookmaker choose Russia and the match Russia 4-2  USA (Russia win 2 goals)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -200, {from: bookmaker, value: betAmount});
      ...
      it('should transfer to punter when  pair is [Russia 0:2 USA] (2.00) and bookmaker choose Russia and the match Russia 4-3  USA (Russia win 1 goals)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -200, {from: bookmaker, value: betAmount});
      ...
      it('should transfer to punter when  pair is [Russia 0:2 USA] (2.00) and bookmaker choose Russia and the match Russia 4-4  USA (Russia draw)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -200, {from: bookmaker, value: betAmount});
      ...
      it('should transfer to punter when  pair is [Russia 0:2 USA] (2.00) and bookmaker choose Russia and the match Russia 4-5  USA (Russia lose)', async () => {
        const amountOfBookMakerBeforeOffer = await web3.eth.getBalance(bookmaker).toNumber();
        const amountOfPunterBeforeDeal = await  web3.eth.getBalance(punter).toNumber();
        contract.offerNewMatch(0x138, homeTeam, awayTeam, 0, matchTime, -200, {from: bookmaker, value: betAmount});
