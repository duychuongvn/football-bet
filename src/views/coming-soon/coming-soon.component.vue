<template src="./coming-soon.component.html"></template>
<style lang="scss" scoped src="./coming-soon.component.scss"></style>
...
<script lang="ts">
  ...
  export default class ComingSoonPage extends Vue {

    public deadlineTime = '2018/09/08 00:00:00';
